...
func SearchCharactersByName(keyWord string) ([]byte, error) {
	...
	out := searhCharactersByName(server, keyWord)
...
func searhCharactersByName(server *http.Server, keyWord string) []byte {
