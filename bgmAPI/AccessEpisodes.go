...
func SearchEpisodesByEpisodesId(Id string) ([]byte, error) {
	...
	out := searchEpisodesByEpisodesId(server, Id)
...
func searchEpisodesByEpisodesId(server *http.Server, Id string) []byte {
...
func episodesAccess(Id string) (map[string]interface{}, error) {
	...
	apiURL := fmt.Sprintf("https://api.bgm.tv/v0/episodes/%s", Id)
