...
func SearchSubjectById(Id string) ([]byte, error) {
	...
	out := searchSubjectById(server, Id)
...
func searchSubjectById(server *http.Server, Id string) []byte {
